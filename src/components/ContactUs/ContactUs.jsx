        ...
        <div className="container">
          <div className="row mt-none-30 justify-content-center">
            <div className="col-lg-4 col-md-6">
              <div className="contact__info--item text-center mt-30">
                ...
                <h3 className="title">address line</h3>
                <p>
                  Bowery St, New York, <br /> NY 10013,USA
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="contact__info--item text-center mt-30">
                ...
                <h3 className="title">Mail Adress</h3>
          ...
          <div className="row mt-40">
            <div className="col-12">
              <div className="contact-from-inner mb--none-140">
